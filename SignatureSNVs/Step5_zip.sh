...
while read -r fam seed uniqueness threshold familythreshold minreads study;
do
    if [[ "$study" == *"Suez"* ]]; then
        echo $strain;
        bzip2 -k /u/scratch/b/briscoel/"$study"Files/CATTED_fam_"$fam"_seed_"$seed"_uniqueness_"$uniqueness"_threshold_"$threshold"_familythresh_"$familythreshold"_minreads_"$minreads"_binned_freq.csv
        #bzip2 -k /u/home/b/briscoel/project-ngarud/FEASTX/BackhedFiles/CATTED_fam_"$fam"_seed_"$seed"_uniqueness_"$uniqueness"_threshold_"$threshold"_familythresh_"$familythreshold"_minreads_"$minreads"_freq.csv
        bzip2 -k /u/scratch/b/briscoel/"$study"Files/CATTED_fam_"$fam"_seed_"$seed"_uniqueness_"$uniqueness"_threshold_"$threshold"_familythresh_"$familythreshold"_minreads_"$minreads"_counts.csv
        ...
        bzip2 -k /u/home/b/briscoel/project-ngarud/FEASTX/"$study"Files/CATTED_fam_"$fam"_seed_"$seed"_uniqueness_"$uniqueness"_threshold_"$threshold"_familythresh_"$familythreshold"_minreads_"$minreads"_binned_freq.csv
        #bzip2 -k /u/home/b/briscoel/project-ngarud/FEASTX/BackhedFiles/CATTED_fam_"$fam"_seed_"$seed"_uniqueness_"$uniqueness"_threshold_"$threshold"_familythresh_"$familythreshold"_minreads_"$minreads"_freq.csv
        bzip2 -k /u/home/b/briscoel/project-ngarud/FEASTX/"$study"Files/CATTED_fam_"$fam"_seed_"$seed"_uniqueness_"$uniqueness"_threshold_"$threshold"_familythresh_"$familythreshold"_minreads_"$minreads"_counts.csv
